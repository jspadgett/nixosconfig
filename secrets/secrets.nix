...
let
  ...
  hestia = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIO7jAAItDDbcwBhVuKbH8omjjf6ajK20JiJL5n1xhDsz root@hestia";
in {
  "joshua-password.age".publicKeys = [ aether athena joshua hestia ];
  "anna-password.age".publicKeys = [ athena joshua ];
  "melissa-password.age".publicKeys = [ hestia joshua ];
